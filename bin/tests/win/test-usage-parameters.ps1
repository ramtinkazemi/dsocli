...
Invoke-Call -ScriptBlock {dso parameter list -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -s ${stage} --namespace-scope --uninherited -f compact | dso parameter delete -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -s ${stage} --namespace-scope -i - -f compact} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter list -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" --uninherited -f json | dso parameter delete -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -i -} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter list -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -s ${stage} --uninherited -f json | dso parameter delete -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -s ${stage} -i -} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter list -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -s "${stage}/2" --uninherited -f json | dso parameter delete -v6 --config "namespace=${namespace}, application=${application}, parameter.provider.id=${provider}" -s "${stage}/2" -i -} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso config add -v6 parameter.provider.id ${provider}} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter add -v6 global.parameter global_parameter --global-scope} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 global.stage_parameter global_stage_parameter -s ${stage} --global-scope`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 global.stage_parameter global_stage_parameter -s ${stage} --global-scope} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 namespace.parameter namespace_parameter --namespace-scope`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 namespace.parameter namespace_parameter --namespace-scope} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 namespace.stage_parameter namespace_stage_parameter -s ${stage} --namespace-scope`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 namespace.stage_parameter namespace_stage_parameter -s ${stage} --namespace-scope} -ErrorAction Stop > $null


Write-Output "`ndso parameter add -v6 app_parameter app_parameter`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 app_parameter app_parameter} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 app_stage_parameter app_stage_parameter -s ${stage}`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 app_stage_parameter app_stage_parameter -s ${stage}} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 app_stage2_parameter app_stage2_parameter -s `"${stage}/2`"`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 app_stage2_parameter app_stage2_parameter -s "${stage}/2"} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter global_overridden_parameter --global-scope} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 overriden_parameter global_stage_overridden_parameter -s ${stage} --global-scope`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter global_stage_overridden_parameter -s ${stage} --global-scope} -ErrorAction Stop > $null


Write-Output "`ndso parameter add -v6 overriden_parameter namespace_overridden_parameter --namespace-scope`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter namespace_overridden_parameter --namespace-scope} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 overriden_parameter namespace_stage_overridden_parameter -s ${stage} --namespace-scope`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter namespace_stage_overridden_parameter -s ${stage} --namespace-scope} -ErrorAction Stop > $null


Write-Output "`ndso parameter add -v6 overriden_parameter app_overridden_parameter`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter app_overridden_parameter} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 overriden_parameter app_stage_overridden_parameter -s ${stage}`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter app_stage_overridden_parameter -s ${stage}} -ErrorAction Stop > $null

Write-Output "`ndso parameter add -v6 overriden_parameter app_stage2_overridden_parameter -s `"${stage}/2`"`n"
Invoke-Call -ScriptBlock {dso parameter add -v6 overriden_parameter app_stage2_overridden_parameter -s "${stage}/2"} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter get -v6 overriden_parameter --global-scope -f text} -ErrorAction Stop > $null

Write-Output "`ndso parameter get -v6 overriden_parameter --namespace-scope -f text`n"
Invoke-Call -ScriptBlock {dso parameter get -v6 overriden_parameter --namespace-scope -f text} -ErrorAction Stop > $null

Write-Output "`ndso parameter get -v6 overriden_parameter -s ${stage} -f text`n"
Invoke-Call -ScriptBlock {dso parameter get -v6 overriden_parameter -s ${stage} -f text} -ErrorAction Stop > $null

Write-Output "`ndso parameter get -v6 overriden_parameter -s `"${stage}/2`" -f text`n"
Invoke-Call -ScriptBlock {dso parameter get -v6 overriden_parameter -s "${stage}/2" -f text} -ErrorAction Stop > $null

Write-Output "`ndso parameter get -v6 app_parameter -s ${stage} -f text`n"
Invoke-Call -ScriptBlock {dso parameter get -v6 app_parameter -s ${stage} -f text} -ErrorAction Stop > $null

Write-Output "`ndso parameter get -v6 app_stage_parameter -s ${stage} -f text`n"
Invoke-Call -ScriptBlock {dso parameter get -v6 app_stage_parameter -s ${stage} -f text} -ErrorAction Stop > $null

Write-Output "`ndso parameter get -v6 app_stage2_parameter -s `"${stage}/2`" -f text`n"
Invoke-Call -ScriptBlock {dso parameter get -v6 app_stage2_parameter -s "${stage}/2" -f text} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso parameter history -v6 overriden_parameter -f json} -ErrorAction Stop > $null

Write-Output "`ndso parameter history -v6 overriden_parameter -s ${stage} -f json`n"
Invoke-Call -ScriptBlock {dso parameter history -v6 overriden_parameter -s ${stage} -f json} -ErrorAction Stop > $null

Write-Output "`ndso parameter history -v6 app_parameter --query-all -f json`n"
Invoke-Call -ScriptBlock {dso parameter history -v6 app_parameter --query-all -f json} -ErrorAction Stop > $null

Write-Output "`ndso parameter history -v6 app_stage_parameter -s ${stage} --query-all -f json`n"
Invoke-Call -ScriptBlock {dso parameter history -v6 app_stage_parameter -s ${stage} --query-all -f json} -ErrorAction Stop > $null

Write-Output "`ndso parameter history -v6 app_stage2_parameter -s `"${stage}/2`" --query-all -f json`n"
Invoke-Call -ScriptBlock {dso parameter history -v6 app_stage2_parameter -s "${stage}/2" --query-all -f json} -ErrorAction Stop > $null
