...
Write-Output "`ndso template list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"template.provider.id=${provider}`" --global-scope --uninherited -f json | dso template delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"template.provider.id=${provider}`" --global-scope -i - -f json`n"
Invoke-Call -ScriptBlock {dso template list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" --global-scope --uninherited -f json | dso template delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" --global-scope -i - -f json} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso template list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" -s ${stage} --global-scope --uninherited -f yaml | dso template delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" -s ${stage} --global-scope -i - -f yaml} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso template list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" --project-scope --uninherited | dso template delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" --project-scope -i -} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso template list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" -s ${stage} --project-scope --uninherited | dso template delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" -s ${stage} --project-scope -i -} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso template list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" -s ${stage} --uninherited | dso template delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "template.provider.id=${provider}" -s ${stage} -i -} -ErrorAction Stop > $null
...
# Write-Output "`ndso template get -b5 -w `"${working_dir}`" overriden_template -f raw`n"
# Invoke-Call -ScriptBlock {dso template get -b5 -w "${working_dir}" overriden_template -f raw} -ErrorAction Stop > $null
...
Write-Output "`ndso template history -b5 -w `"${working_dir}`" overriden_template -f json`n"
Invoke-Call -ScriptBlock {dso template history -b5 -w "${working_dir}" overriden_template -f json} -ErrorAction Stop > $null
...
Invoke-Call -ScriptBlock {dso template list -b5 -w "${working_dir}" -s ${stage} --query-all -f yaml} -ErrorAction Stop > "tests/output/template/app-all-${filename}.yaml"
