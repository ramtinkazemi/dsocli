...
Write-Output "`ndso parameter list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" --global-scope --uninherited -f json | dso parameter delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" --global-scope -i - -f json`n"
Invoke-Call -ScriptBlock {dso parameter list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" --global-scope --uninherited -f json | dso parameter delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" --global-scope -i - -f json} -ErrorAction Stop > $null

Write-Output "`ndso parameter list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" -s ${stage} --global-scope --uninherited -f yaml | dso parameter delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" -s ${stage} --global-scope -i - -f yaml`n"
Invoke-Call -ScriptBlock {dso parameter list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -s ${stage} --global-scope --uninherited -f yaml | dso parameter delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -s ${stage} --global-scope -i - -f yaml} -ErrorAction Stop > $null

Write-Output "`ndso parameter list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" --project-scope --uninherited | dso parameter delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" --project-scope -i -`n"
Invoke-Call -ScriptBlock {dso parameter list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" --project-scope --uninherited | dso parameter delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" --project-scope -i -} -ErrorAction Stop > $null

Write-Output "`ndso parameter list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" -s ${stage} --project-scope --uninherited -f shell | dso parameter delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" -s ${stage} --project-scope -i - -f shell`n"
Invoke-Call -ScriptBlock {dso parameter list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -s ${stage} --project-scope --uninherited -f shell | dso parameter delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -s ${stage} --project-scope -i - -f shell} -ErrorAction Stop > $null

Write-Output "`ndso parameter list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" --uninherited | dso parameter delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" -i -`n"
Invoke-Call -ScriptBlock {dso parameter list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" --uninherited | dso parameter delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -i -} -ErrorAction Stop > $null

Write-Output "`ndso parameter list -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}` -s ${stage} --uninherited | dso parameter delete -b5 -w `"${working_dir}`" --namespace ${namespace} --project ${project} --application ${application} --config `"parameter.provider.id=${provider}`" -s ${stage} -i -`n"
Invoke-Call -ScriptBlock {dso parameter list -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -s ${stage} --uninherited | dso parameter delete -b5 -w "${working_dir}" --namespace ${namespace} --project ${project} --application ${application} --config "parameter.provider.id=${provider}" -s ${stage} -i -} -ErrorAction Stop > $null
